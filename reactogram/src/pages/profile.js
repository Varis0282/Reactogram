...
const Profile = () => {
  ...
  useEffect(() => {
    getMyPosts();//eslint-disable-next-line
  }, []);
  return (
    user.user!==null && (
      <div className="container shadow mt-3 p-4">
        ...
        <div className="row">
          <div className="col-md-6 d-flex flex-column">
            ...
            <p className="ms-3 fs-5">{user.user.username}</p>
            <p className="ms-3 fs-5">
              ...
              || Follow{" "}
              <a href="varisrajak.onrender.com">
                <b>{user.user.fullName}</b>
              </a>
            </p>
            <p className="ms-3 fs-5">
              My link : <a href="varisrajak.onrender.com">{user.user.fullName}</a>
            </p>
          </div>
              ...
              <div className="col-md-6 col-sm-12 ps-5 pt-3 pb-5 mb-4">
                {fileUploaded ? (
                  ...
                  <div className="dropZoneContainer upload-box d-flex flex-column justify-content-center align-items-center text-center">
                    ...
                    <label
                      htmlFor="drop zone"
                      className="mb-0  d-flex flex-column justify-content-center align-items-center text-center"
                    >
                      <i
                        role="button"
