                    ...
                    <div className="card shadow">
                        <div className="card-body px-5">
                            ...
                            <form onSubmit={(e) => { login(e) }}>
                                <input type="text" value={email} onChange={(ev) => { setEmail(ev.target.value); if(ev.target.value==="")setDisabled(true)}} className="p-2 mt-4 mb-2 form-control input-bg" placeholder='Phone number, username or email' />
                                ...
                                <div className="mt-3 d-grid">
                                    {
                                        loading ?
                                            ...
                                            :
                                            <button type="submit" className={disabled ? "custom-btn custom-btn-blue custom-btn-disabled" : "custom-btn custom-btn-blue"} disabled={disabled}>Login</button>
                                    }
                                </div>
                                <div className="my-4">
