                    ...
                    <div className="card shadow">
                        ...
                        <div className="card-body px-5">
                            ...
                            <form onSubmit={(e) => signup(e)}>
                                <input type="tel" value={phoneNo} onChange={(ev) => setPhoneno(ev.target.value)} className="p-2 mt-4 mb-2 form-control input-bg" placeholder='Phone' />
                                <input type="text" value={userName} onChange={(ev) => setUserName(ev.target.value)} className="p-2 mb-2 form-control input-bg" placeholder='Username' />
